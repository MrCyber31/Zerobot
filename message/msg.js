...
const { getBuffer, fetchJson, fetchText, getRandom, getGroupAdmins, runtime, sleep, formatp, makeid } = require("../lib/myfunc");
...
// Setting Donasi
const gopay = "0888-2379-922"
const ovo = "0888-2379-922"
const dana = "0888-2379-922"
const pulsa = "0821-1962-3364"
const pulsa2 = "0888-2379-922"
...
module.exports = async(conn, msg, m, setting, store) => {
    ...
    const readmore = more.repeat(4001)
		...
		function mentions(teks, mems = [], id) {
          ...
          message: {
            imageMessage: {
              ...
              mimetype: "image/jpeg",
              caption: `Hello ${pushname !== undefined ? pushname : 'Kak'} 👋🏻 ${ucapanWaktu}`,
		...
		const buttonsDefault = [
			{ urlButton: { displayText: `Webiste Apikey`, url : `https://api-zerobot.xyz` } },
			{ urlButton: { displayText: `Group`, url : `https://chat.whatsapp.com/CeYnU6Nk1FaGg41YUvMZ3v` } },
			{ quickReplyButton: { displayText: `Donasi`, id: `${prefix}donate` } },
			{ quickReplyButton: { displayText: `Owner`, id: `${prefix}owner` } },
			{ quickReplyButton: { displayText: `Info Bot`, id: `${prefix}infobot` } },
		]
		const button5 = [
			{ callButton: { displayText: `Number Owner`, phoneNumber: `0888-2379-922` } },
			{ urlButton: { displayText: `Group`, url : `https://chat.whatsapp.com/CeYnU6Nk1FaGg41YUvMZ3v` } },
...
if (chats.startsWith("@628882379922")){
...
if (chats.startsWith("Sahur")){
	conn.sendMessage(from, { audio: {url : `https://h.top4top.io/m_2283svzf00.mp3`}, mimetype: 'audio/mp4', ptt: true}, {quoted: msg})
	}
...
if (chats.startsWith("woy")){
   conn.sendMessage(from, { audio: {url : `https://d.top4top.io/m_22231oj7h1.mp3`}, mimetype: 'audio/mp4', ptt: true}, {quoted: msg})
		...
		switch(command) {
			...
			case prefix+'menu':
			case prefix+'help':
			  conn.sendMessage(from, { audio: fs.readFileSync('audio/ojo.mp3'), mimetype: 'audio/mp4', ptt: true}, {quoted: msg})
			    var teks = allmenu(sender, prefix, pushname, isOwner, isPremium, balance, limit, limitCount, glimit, gcount)

conn.sendMessage(from, { caption: teks, image: {url: `https://up.rzkyfdlh.tech/file/GTmGDE2wFr40.jpg`}, quoted: fgc, templateButtons: buttonsDefault, footer: 'Website Me:\n\nApikey: Api-zerobot.xyz\nGithub: github.com/MrCyber31\ninstagram: instagram.com/avid_mv\nWhatsapp: +95 9 662 592452\nEmail: mrcyber51@yahoo.com', mentions: [sender]})
				break
case prefix+'donasiah':
  reply(`Jika Ingin Donasi Harap Hubungi Owner\n\nhttps://wa.me/628882379922`)
  break
case prefix+'donasi':
  case prefix+'donate':
  var donasibut = [
...
- Rp.50.000 - Lima Bulan`
			    conn.sendMessage(from, { caption: teks, location: { jpegThumbnail: fs.readFileSync(setting.pathimg) }, templateButtons: button5, footer: '© Zero BOT', mentions: [sender] })
			    break
			case prefix+'runtime':
			    reply(runtime(process.uptime()))
			    break
case prefix+'groupjojo':
  reply("Group 1\n\nhttps://chat.whatsapp.com/CeYnU6Nk1FaGg41YUvMZ3v")
  break
			case prefix+'speed':
			    let timestamp = speed();
...
*Nama Bot :* Zero BOT
*Name Owner :* Avid
*Nomor Bot :* wa.me/4365076777797
*Nomor Owner :* wa.me/628882379922
*Engine :* NodeJs
*Status :* Aktif
...
conn.sendMessage(from, {caption: caption, image: {url: `https://up.rzkyfdlh.tech/file/GTmGDE2wFr40.jpg`}}, {quoted: msg})
break
			/*case prefix+'donate':
			case prefix+'donasi':
			    reply(`◪ DONASI
  ...
  Note : Donasi Seikhlasnya`)
			...
			case prefix+'owner':
			    for (let x of ownerNumber) {
			      sendContact(from, x.split('@s.whatsapp.net')[0], 'Avid', msg)
			    }
			    conn.sendMessage(from, { audio: {url : `https://b.top4top.io/m_2223iin241.mp3`}, mimetype: 'audio/mp4', ptt: true}, {quoted: msg})
			    break
			case prefix+'cekprem':
...
case prefix+'resetlimit':
              ...
              limit.splice('reset')
              fs.writeFileSync('./limit.json', JSON.stringify(limit))
              break
...
case prefix+'bc': case prefix+'broadcast':
			    if (!isOwner) return reply(mess.OnlyOwner)
		            if (args.length < 2) return reply(`Masukkan isi pesannya`)
                            ...
                            for (let i of data) {
                               conn.sendMessage(i.id, { text:  `*• Broadcast Messages*\n\n${q}`, contextInfo: { mentionedJid: [sender],"forwardingScore":2,"isForwarded":true},sendEphemeral: true })
                               await sleep(1000)
                            }
                            break
...
conn.sendMessage(from, { text: anjayani, buttons: but, footer: "© Zero BOT", templateButtons: but }, {quoted: msg})
				limitAdd(sender, limit)
				break
...
conn.sendMessage(from, { text: slotnya, buttons: but, footer: "© Zero BOT", templateButtons: but }, {quoted: msg})
gameAdd(sender, glimit)
        break
case prefix+'cekme':
  case prefix+'me':
...
var but = [{buttonId: '/y', buttonText: { displayText: 'Cocok' }, type: 1 }, {buttonId: '/n', buttonText: { displayText: 'Gak Cocok' }, type: 1 }]
					conn.sendMessage(from, { caption: cek, image: { url: `https://telegra.ph/file/a48660964fc598016dc71.png` }, buttons: but, footer: '© Zero BOT' }, { quoted: msg })
				    limitAdd(sender, limit)
				    break
case prefix+'y':
...
case prefix+'add':
  if (!isOwner)return reply("_Maaf Fitur Ini Di Nonaktifkan Oleh Owner, Karena menyebabkan nomer bot 3 kali ke banned_")
    ...
    break
            ...
            case prefix+'tf':{
                 if (args.length < 2) return reply(`Kirim perintah *${command}* @tag nominal\nContoh : ${command} @628882379922 2000`)
...
conn.sendMessage(from, {caption: "© Zero BOT", image: { url: `https://hadi-api.herokuapp.com/api/photoxy/tiktok-effect?text=${args[1]}&text2=${args[2]}`}}, {quoted: msg})
limitAdd(sender, limit)
break
case prefix+'flaming':
  ...
  if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
  reply("Tunggu Sebentar Sedang Membuat Makernya Sekitar 1 Menit Kurang")
conn.sendMessage(from, {caption: "© Zero BOT", image: { url: `https://hadi-api.herokuapp.com/api/photoxy/flaming-fire?text=${q}`}}, {quoted: msg})
limitAdd(sender, limit)
break
case prefix+'shadow':
  ...
  if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
  reply("Tunggu Sebentar Sedang Membuat Makernya Sekitar 1 Menit Kurang")
conn.sendMessage(from, {caption: "© Zero BOT", image: { url: `https://hadi-api.herokuapp.com/api/photoxy/shadow-sky?text=${q}`}}, {quoted: msg})
limitAdd(sender, limit)
break
case prefix+'wolftext':
  ...
  if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
  reply("Tunggu Sebentar Sedang Membuat Makernya Sekitar 1 Menit Kurang")
conn.sendMessage(from, {caption: "© Zero BOT", image: { url: `https://hadi-api.herokuapp.com/api/photoxy/wolf-metal?text=${q}`}}, {quoted: msg})
limitAdd(sender, limit)
break
case prefix+'cup':
  if (args.length < 2) return reply(`Kirim perintah ${command} <Text1>`)
  if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
  reply("Tunggu Sebentar Sedang Membuat Makernya Sekitar 1 Menit Kurang")
conn.sendMessage(from, {caption: "© Zero BOT", image: { url: `https://hadi-api.herokuapp.com/api/photoxy/teks-cup?text=${q}`}}, {quoted: msg})
limitAdd(sender, limit)
break
case prefix+'romantic':
  ...
  if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
  reply("Tunggu Sebentar Sedang Membuat Makernya Sekitar 1 Menit Kurang")
conn.sendMessage(from, {caption: "© Zero BOT", image: { url: `https://hadi-api.herokuapp.com/api/photoxy/romantic-messages?text=${q}`}}, {quoted: msg})
limitAdd(sender, limit)
break
case prefix+'writetext':
  ...
  if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
  reply("Tunggu Sebentar Sedang Membuat Makernya Sekitar 1 Menit Kurang")
conn.sendMessage(from, {caption: "© Zero BOT", image: { url: `https://hadi-api.herokuapp.com/api/photoxy/burn-paper?text=${q}`}}, {quoted: msg})
limitAdd(sender, limit)
break
case prefix+'cup2':
  if (args.length < 2) return reply(`Kirim perintah ${command} <Text1>`)
  if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
  reply("Tunggu Sebentar Sedang Membuat Makernya Sekitar 1 Menit Kurang")
conn.sendMessage(from, {caption: "© Zero BOT", image: { url: `https://hadi-api.herokuapp.com/api/photoxy/funny-cup?text=${q}`}}, {quoted: msg})
limitAdd(sender, limit)
break
case prefix+'lovetext':
  ...
  if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
  reply("Tunggu Sebentar Sedang Membuat Makernya Sekitar 1 Menit Kurang")
conn.sendMessage(from, {caption: "© Zero BOT", image: { url: `https://hadi-api.herokuapp.com/api/photoxy/love-messages?text=${q}`}}, {quoted: msg})
limitAdd(sender, limit)
break
case prefix+'lovetext2':
  ...
  if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
  reply("Tunggu Sebentar Sedang Membuat Makernya Sekitar 1 Menit Kurang")
conn.sendMessage(from, {caption: "© Zero BOT", image: { url: `https://hadi-api.herokuapp.com/api/photoxy/romantic-double?text=${q}`}}, {quoted: msg})
limitAdd(sender, limit)
break
case prefix+'undergrass':
  ...
  if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
  reply("Tunggu Sebentar Sedang Membuat Makernya Sekitar 1 Menit Kurang")
conn.sendMessage(from, {caption: "© Zero BOT", image: { url: `https://hadi-api.herokuapp.com/api/photoxy/under-grass?text=${q}`}}, {quoted: msg})
limitAdd(sender, limit)
break
...
case prefix+'coffecup':
  ...
  if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
  reply("Tunggu Sebentar Sedang Membuat Makernya Sekitar 1 Menit Kurang")
conn.sendMessage(from, {caption: "© Zero BOT", image: { url: `https://hadi-api.herokuapp.com/api/photoxy/coffee-cup?text=${q}`}}, {quoted: msg})
limitAdd(sender, limit)
break
...
conn.sendMessage(from, {caption: "© Zero BOT", image: { url: `https://hadi-api.herokuapp.com/api/photoxy/wood-hearth?text=${q}`}}, {quoted: msg})
limitAdd(sender, limit)
break
...
case prefix+'darkjokes': case prefix+'dark': case prefix+'darkjoke':
  ...
  var data = await fetchJson(`https://hadi-api.herokuapp.com/api/darkjokes`)
				conn.sendMessage(from, { caption: "© Zero BOT", image: { url: data.result }, buttons: but, footer: 'Pencet tombol dibawah untuk foto selanjutnya' }, { quoted: msg })
limitAdd(sender, limit)
break
